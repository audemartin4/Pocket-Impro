...
const CATEGORIES_A_FUSIONNER = [
  ...
  { name: "Flashback", summary: "Quand un joueur dit « ça me rappelle quand... » on fait un flashback", level: "Confirmé", playersMin: 2, playersMax: 8, energy: "Forte", duration: 4, tags: ["Narration"], objectives: ["ça me rappelle", "tu te souviens", "écoute", "imagination"], thematiques: [], archetypes: [], showTypes: ["Cabaret", "Match", "Concept original"], famillesObjectifs: [] },
  ...
  { name: "Carré hollandais", summary: "4 joueurs qui tournent au sifflet du MC", level: "Débutant", playersMin: 4, playersMax: 4, energy: "Forte", duration: 6, tags: ["Contrainte physique"], objectives: ["MC", "intervention MC", "jeu", "physique", "corps"], thematiques: [], archetypes: [], showTypes: ["Cabaret", "Match", "Concept original"], famillesObjectifs: [] },
  ...
  { name: "Je remake mal / J'imite mal", summary: "On demande à un joueur d'imiter une personnalité ou de remaker un film", level: "Débutant", playersMin: 2, playersMax: 8, energy: "Forte", duration: 3, tags: ["Solo/duo et début/fin de spectacle"], objectives: ["personnage", "cinéma", "film"], thematiques: [], archetypes: [], showTypes: ["Cabaret", "Match", "Concept original"], famillesObjectifs: [] },
  { name: "Toaster", summary: "Les joueurs s'accroupissent, quand le MC fait « ting » un nombre de joueurs aléatoire saute et commence une impro", level: "Débutant", playersMin: 2, playersMax: 8, energy: "Forte", duration: 3, tags: ["Solo/duo et début/fin de spectacle"], objectives: ["MC", "intervention MC", "imprévu", "spontanéité"], thematiques: [], archetypes: [], showTypes: ["Cabaret", "Match", "Concept original"], famillesObjectifs: [] },
  { name: "Schizophrenia / Un pour tous", summary: "Le joueur doit faire plusieurs perso", level: "Avancé", playersMin: 1, playersMax: 1, energy: "Forte", duration: 4, tags: ["Solo/duo et début/fin de spectacle"], objectives: ["personnage", "voix"], thematiques: [], archetypes: [], showTypes: ["Cabaret", "Match", "Concept original"], famillesObjectifs: [] },
  { name: "Zapping / Videowave / Scroll", summary: "Des couples de joueurs jouent des emissions de télévision, ou des chaînes youtube au sifflet du MC", level: "Débutant", playersMin: 2, playersMax: 8, energy: "Forte", duration: 4, tags: ["Solo/duo et début/fin de spectacle"], objectives: ["MC", "intervention MC", "binôme", "duo", "imprévu"], thematiques: [], archetypes: [], showTypes: ["Cabaret", "Match", "Concept original"], famillesObjectifs: [] },
  { name: "Mitraillette", summary: "Impros solos ou duo à la suite", level: "Confirmé", playersMin: 2, playersMax: 8, energy: "Forte", duration: 2, tags: ["Solo/duo et début/fin de spectacle"], objectives: ["binôme", "duo", "imprévu", "spontanéité"], thematiques: [], archetypes: [], showTypes: ["Cabaret", "Match", "Concept original"], famillesObjectifs: [] },
  ...
  { name: "Voyage dans le temps", summary: "Au sifflet de l'arbitre la scène change de période temporelle. Moyen âge, futur, révolution française, antiquité, préhistoire", level: "Confirmé", playersMin: 2, playersMax: 8, energy: "Forte", duration: 4, tags: ["Répétition"], objectives: ["MC", "intervention MC", "zone", "époque", "histoire"], thematiques: [], archetypes: [], showTypes: ["Cabaret", "Match", "Concept original"], famillesObjectifs: [] },
  { name: "Cyclothymique", summary: "On refait plusieurs fois une scène mais le MC donne une émotion générale pour tous les acteurs à chaque répétition. Joie débordante Colère explosive Tristesse profonde Panique Fierté Envie Frustration Honte Excitation Peur irrationnelle Sérénité Doute Amour excessif Dégoût Ennui total Euphorie Confusion Nostalgie Suspicion", level: "Confirmé", playersMin: 2, playersMax: 8, energy: "Forte", duration: 2, tags: ["Répétition"], objectives: ["MC", "intervention MC", "emotion"], thematiques: [], archetypes: [], showTypes: ["Cabaret", "Match", "Concept original"], famillesObjectifs: [] },
  { name: "Best-of", summary: "Un meddley de toutes les impros qui ont été jouées.", level: "Avancé", playersMin: 2, playersMax: 8, energy: "Forte", duration: 2, tags: ["Répétition"], objectives: ["écoute", "mémoire", "imprévu"], thematiques: [], archetypes: [], showTypes: ["Cabaret", "Match", "Concept original"], famillesObjectifs: [] },
  ...
  { name: "Ça mérite une chanson", summary: "Le MC arrête l'impro et dit \"ça mérite une chanson\", les joueurs doivent improviser la chanson", level: "Confirmé", playersMin: 2, playersMax: 8, energy: "Forte", duration: 3, tags: ["Musicales"], objectives: ["MC", "intervention MC", "voix", "musique", "chant"], thematiques: [], archetypes: [], showTypes: ["Cabaret", "Match", "Concept original"], famillesObjectifs: [] },
  ...
  { name: "Libre", summary: "Scène libre, sans contrainte imposée ni thème particulier.", level: "", playersMin: 2, playersMax: 8, energy: "Modérée", duration: 4, tags: [], objectives: [], thematiques: [], archetypes: [], showTypes: ["Cabaret", "Match", "Concept original"], famillesObjectifs: [] },
...
function GenerateurSpectacleTab({ data, allData, update, plan, setPlan, currentUser, setTab }) {
  ...
  const replaceCat = (part, idx) => {
    ...
    let pool = data.categories.filter((c) => !used.has(c.id));
    if (niveau) {
